...
namespace Microsoft.DiaSymReader
{
    ...
    internal interface ISymUnmanagedWriter5
    {
        ...
        void DefineLocalVariable2(string name, uint attributes, int localSignatureToken, uint addrKind, int index, uint addr2, uint addr3, uint startOffset, uint endOffset);
        void DefineGlobalVariable2(string name, uint attributes, int sigToken, uint addrKind, uint addr1, uint addr2, uint addr3);
