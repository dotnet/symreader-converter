...
namespace Microsoft.DiaSymReader.Tools
{
    ...
    /// </remarks>
    internal static unsafe class ImmutableArrayInterop<T>
    {
        /// <summary>
        ...
        internal static ImmutableArray<T> DangerousCreateFromUnderlyingArray(ref T[] array)
        {
            T[] givenArray = array;
            array = null;
        ...
        internal static T[] DangerousGetUnderlyingArray(ImmutableArray<T> array)
        {
            var union = new ArrayUnion();
        ...
        {
            [FieldOffset(0)]
            internal T[] UnderlyingArray;

            [FieldOffset(0)]
            internal ImmutableArray<T> ImmutableArray;
        }
    }
}